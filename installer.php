...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'brandcenter_finxi_ec8ea90515f2549d1650_20210504223736_archive.zip';
	const ARCHIVE_SIZE		 = '42972444';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ec8ea90-04223736';
    const SECONDARY_PACKAGE_HASH = 'd7146b6-04223736';
	const VERSION			 = '1.4.0';
